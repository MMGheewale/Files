                                ...
                                <center>
                                    ...
                                    <form name="f" id="ContactForm" method="post" action="" onsubmit="javascript:return check();"><br/>
                                        <table cellpadding="2px;">
                                            ...
                                            <tr><td><span>&nbsp;</span></td><td></td></tr>
                                            <tr><td><span>Not a Robot</span></td><td><input type="text" name="captcha" placeholder="Enter Displayed Code" name="captcha" required maxlength="16"/>&nbsp;<img src="captcha.php" /></td></tr>
                                            <tr><td><span>&nbsp;</span></td><td></td></tr>
                                        ...
                                        if ($_SESSION["code"] != $_POST["captcha"]) {
                                            ...
                                            include 'dbconnection1.php';
                                                    ...
                                                    if ($result->num_rows > 0) 
                                                        {
                                                            echo "<script>window.location.href='register.php?m=You are already registered'</script>";
                                                        }else{
