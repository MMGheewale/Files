                  ...
                  <a class="navbar-brand mu-logo" href="index.php"><p id="firstname"><span><i>DROP IN</i></span></p></a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto mu-navbar-nav">
                            ...
                            <li class="nav-item"><a href="buy.php">Buy</a></li>
							
                            <li class="nav-item active">
                                <a href="sucess.php">Sucess</a>
                            </li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="mu-page-header-area">
                            ...
                            <div class="aa">
                                <h3>The order was Sucessfully Placed</br></br>Payment Method : placed on cash of delivery </h3>
