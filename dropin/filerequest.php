                    ...
                    <div class="col-md-12">
                        <div class="mu-page-header-area">
                            ...
                            <div class="aa">
                                ...
                                $query175 = "SELECT files.name, files.type, files.size,files.hash, files.hash, requests.message, requests.ip FROM files INNER JOIN requests ON requests.owner='{$owner}'and requests.status='blocked' and files.hash=requests.hash";
                                $result175 = $conn->query($query175) or die( mysqli_error($conn));
                                ?>
                                ...
                                <?php
                                         while ($row = mysqli_fetch_array($result175, MYSQLI_ASSOC)) {
                                                                    ...
                                                                    ?>
                                                                    <tr><td align="center"><?php echo $row['type'] ?></td>"
                                                                        <td align="center"><?php echo $row['type'] ?></td>
                                                                        <td align="right"><?php echo $row['size'] ?></td>
                                                                        <td><?php echo $row['message'] ?></td>                                                                               
                                                                        <td><a href="deleterequest.php?hash=<?php echo $row['hash']?>&ip=<?php echo $row['ip']?>"><center><img src="images/delete_icon.png"></center></a></td>
                                                                        <td><a href="userblock.php?hash=<?php echo $row['hash']?>&ip=<?php echo $row['ip']?>"><center><img src="images/block_icon.png"></center></a></td>
                                                                        <td><a href="userunblock.php?hash=<?php echo $row['hash']?>&ip=<?php echo $row['ip']?>"><center><img src="images/unblock_icon.png"></center></a></td></tr>
                                                                    <?php
                                                                }
                                                                echo " </table>";
                                                                ?>
