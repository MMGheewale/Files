                    ...
                    <div class="col-md-12">
                        <div class="mu-page-header-area">
                            ...
                            <div class="aa">
                                ...
                                $query175 = "SELECT * from tbluserlogin";
                                ...
                                <?php
                                         while ($row = mysqli_fetch_array($result175, MYSQLI_ASSOC)) {
                                                                    ...
                                                                    ?>
                                                                    <tr><td align="center"><?php echo $row['email'] ?></td>"
                                                                           
                                                                        <td><a href="deleteuser.php?email=<?php echo $row['email']?>"><center><img src="images/delete_icon.png"></center></a></td>
                                                                         <?php
                                                                }
                                                                echo " </table>";
                                                                ?>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            <div class="mu-footer-bottom-area">
                                                                                <p class="mu-copy-right">&copy; Copyright 2021 <a rel="nofollow" href="index.php">Drop In</a>. All right reserved.</p>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
