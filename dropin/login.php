                            ...
                            <form name="f" id="ContactForm" method="post" action="" onsubmit="javascript:return check();">
                                <div class="aa">
                                    <center>
                                        ...
                                        ?>
                                        <br/><input type="email" name="user"  placeholder="Email ID" required/><br /><br />
                                        <input type="password" name="pass" placeholder="Password" required maxlength="16"/><br /><br />
                                        <input type="submit" value="Let me in" name="log"/><br/><br/>
...
<main>
	...
	if($_POST['user']=="admin@gmail.com" and $_POST['pass']=="admin")
	{
		$_SESSION['id'] = $_POST['user'];
        echo "<script>window.location.href='adminhome.php'</script>";
	}
        
        $sql ="Select * from tbluserlogin where email='{$_POST['user']}' and password='{$_POST['pass']}'";
